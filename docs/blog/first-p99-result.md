...
It means: **workload class at dispatch time can matter under contention**, the experiment is reproducible, and counters will tell you when you have a kick storm instead of a win.
