...
|---|--------|-------------------|
| 1 | [Pod to cgroup to task](01-pod-to-task.md) | Say why kube-scheduler is the wrong layer for this problem |
| 2 | [eBPF and sched_ext](02-ebpf-sched-ext.md) | Say why a Prometheus loop is too slow here |
...
Writing a scheduler from zero, verifier puzzles, energy-aware policies, AI policies. Those are later. If a newcomer cannot finish lesson 3, the course failed. They did not fail.
